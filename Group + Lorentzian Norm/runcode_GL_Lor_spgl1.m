...
for h = 1 : lensize
    ...
    for repeat = 1 : repeats
       ...
       fprintf('Start of SPGL1 \n');
        ...
        % ESQM with delta1
        tesqm1 = tic;
        [x_esqm1, iter_esqm1, flag_esqm1] = L1L2_Lor_ESQM_ls(A, b, gamma, sigma, mu, xin, delta1, L, M, maxiter, freq, tol, n, J);
        t_esqm1 = toc(tesqm1);
        ...
        % ESQM with delta2
        tesqm2 = tic;
        [x_esqm2, iter_esqm2, flag_esqm2] = L1L2_Lor_ESQM_ls(A, b, gamma, sigma, mu, xin, delta2, L, M, maxiter, freq, tol, n, J);
        t_esqm2 = toc(tesqm2);
        ...
        % ESQM with delta3
        tesqm3 = tic;
        [x_esqm3, iter_esqm3, flag_esqm3] = L1L2_Lor_ESQM_ls(A, b, gamma, sigma, mu, xin, delta3, L, M, maxiter, freq, tol, n, J);
        t_esqm3 = toc(tesqm3);
...
a = clock;
fname = ['Results\GL_LorNor_spgl1_table' '-'  date '-' int2str(a(4)) '-' int2str(a(5)) '.txt'];
fid = fopen(fname, 'w');
