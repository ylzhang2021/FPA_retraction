function [x, iter, flag] = L1L2_Lor_ESQM_ls(A, b, gamma, sigma, mu, xstart, delta, L, M, maxiter, freq, tol)
...
while 1 == 1
    ...
    [u, lambda] = subprob_L1L2_ESQM(mu, grad, newsigma1, beta, x, M, lambda); % Solving the subproblem
    Au = A*u;
    utmp = Au - b;
    ...
    while 1 == 1
        ...
        Axtest1 = Ax + t*(Au - Ax);
        tmp1 = Axtest1 - b;
        fval1 = norm(xtest1,1) - mu*norm(xtest1);
