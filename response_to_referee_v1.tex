...
&   0.54 &   3.14 &   9.91 &  24.02 &  45.56\\\cline{2-7} \multirow{1}*{} & \multirow{1}*{Slater}
&   0.01 &   0.02 &   0.05 &   0.09 &   0.17\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{SPGL1}
&   1.53 &   6.83 &  16.34 &  29.91 &  42.23\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{FPA$_{\rm retract}$}
&   3.03 &  13.46 &  29.09 &  52.87 & 104.22\\\cline{2-7} \multirow{1}*{}  & \multirow{1}*{Slater + SPGL1 + FPA$_{\rm retract}$}
&   4.56 &  20.31 &  45.48 &  82.86 & 146.61\\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.5}$}
&   5.19 &  24.17 &  56.22 & 104.01 & 171.79\\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.1}$}
&   4.59 &  20.63 &  47.50 &  86.96 & 143.28\\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.02}$}
&  13.73 &  58.98 & 133.71 & 236.89 & 380.16\\\cline{1-7} \multirow{4}*{Iter} & \multirow{1}*{FPA$_{\rm retract}$}
