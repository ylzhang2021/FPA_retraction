...
\begin{table}[H]
\caption{Computational results for problem (6.2) with initial point $x^0 = (0, 0, \cdots, 0)$}\label{table1}
\begin{center}
{\footnotesize
...
\begin{table}[H]
\caption{Computational results for problem (6.2) with initial point $x^0$ is given as in (6.6)}\label{table1}
\begin{center}
{\footnotesize
\begin{tabular}{|c|c|c|c|c|c|c|}\hline
...
Indeed, the above seems a better title for the work because it connects the core ideas in the manuscript.}
    ...
    \textbf{Response:} Thanks for the comment. We compare the algorithms with SCP presented in [42] on solving problem (6.4):
