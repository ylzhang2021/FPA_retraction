...
&   0.52 &   3.13 &   9.30 &  22.65 &  44.45\\\cline{2-7} \multirow{1}*{} & \multirow{1}*{Slater}
&   0.01 &   0.03 &   0.05 &   0.09 &   0.15\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{SPGL1}
&   1.54 &   6.84 &  16.39 &  30.45 &  42.97\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{FPA$_{\rm retract}$}
&   3.01 &  13.54 &  29.17 &  53.66 & 105.66\\\cline{2-7} \multirow{1}*{}  & \multirow{1}*{Slater + SPGL1 + FPA$_{\rm retract}$}
&   4.57 &  20.40 &  45.60 &  84.20 & 148.78\\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.5}$}
&   5.13 &  24.23 &  56.41 & 105.38 & 173.96\\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.1}$}
&   4.61 &  20.76 &  47.71 &  88.30 & 145.13\\\cline{2-2} \multirow{1}*{}  & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.02}$}
&  13.91 &  59.10 & 134.39 & 241.26 & 386.69\\\cline{1-7} \multirow{4}*{Iter} & \multirow{1}*{FPA$_{\rm retract}$}
&    342 &    406 &    398 &    418 &    533\\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.5}$}
&    766 &    970 &   1027 &   1104 &   1175\\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.1}$}
&    776 &    873 &    905 &    952 &   1002\\\cline{2-2} \multirow{1}*{}     & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.02}$}
&   2446 &   2559 &   2593 &   2626 &   2682\\\cline{1-7} \multirow{5}*{RecErr} & \multirow{1}*{SPGL1}
&  0.054 &  0.055 &  0.048 &  0.046 &  0.066\\\cline{2-7} \multirow{1}*{} & \multirow{1}*{FPA$_{\rm retract}$}
&  0.030 &  0.033 &  0.033 &  0.035 &  0.036\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.5}$}
&  0.030 &  0.033 &  0.033 &  0.035 &  0.036\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.1}$}
&  0.030 &  0.033 &  0.033 &  0.035 &  0.036\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.02}$}
&  0.030 &  0.033 &  0.033 &  0.035 &  0.036\\\cline{1-7} \multirow{5}*{Residual} & \multirow{1}*{SPGL1}
& -2.01e-04 & -1.63e-04 & -1.87e-04 & -1.40e-04 & -9.35e-05\\\cline{2-7} \multirow{1}*{} & \multirow{1}*{FPA$_{\rm retract}$}
& 5.89e-16 & 1.40e-15 & 5.99e-16 & 2.73e-15 & 1.05e-16\\\cline{2-2} \multirow{1}*{} & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.5}$}
& 1.32e-10 & 1.10e-10 & 1.14e-10 & 1.13e-10 & 1.09e-10\\\cline{2-2} \multirow{1}*{}      & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.1}$}
& 1.08e-10 & 9.93e-11 & 1.02e-10 & 9.59e-11 & 9.54e-11\\\cline{2-2} \multirow{1}*{}      & \multirow{1}*{ESQM$_{{\rm ls},\ \delta = 0.02}$}
& 1.01e-10 & 9.83e-11 & 9.26e-11 & 9.35e-11 & 9.32e-11\\\cline{1-7}
\end{tabular}
}
\end{center}
\end{table}
...
&   3.24 &  13.12 &  34.00 & 205.99 & 233.59\\\cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
...
&  18.35 &  82.69 & 195.55 & 329.15 & 397.47\\\cline{1-7} \multirow{5}*{Iter} & \multirow{1}*{SCP$_{\rm ls}$}
...
&  1.699 &  3.423 &  1.826 &  2.630 &  2.465\\\cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
...
& -5.45e-01 & -5.84e-01 & -7.09e-01 & -7.08e-01 & -7.38e-01\\\cline{2-7} \multirow{1}*{} & \multirow{1}*{SCP$_{\rm ls}$}
