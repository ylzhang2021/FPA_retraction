...
\begin{enumerate}
	...
	\textbf{Response:} We believe that our method is closer to SQP-type methods than sequential DC programming method. 
    ...
    This is different from the sequential DC programming which makes use of subproblems whose constraint sets are {\em subset} of the original problem. Hence, solving these DC subproblems will automatically create a feasible point without the need of other strategies such as ``retract".
